          ...
          <div className="flex justify-between items-center gap-4 mb-3">
            ...
            <div className="text-right shrink-0">
              <p className="text-lg font-black text-slate-900">
                {new Intl.NumberFormat().format(supply.quantity)} <span className="text-xs font-bold text-slate-500 ml-1">{supply.quantityUnit || "MT"}</span>
              </p>
              {supply.price ? (
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-6 lg:p-8 bg-slate-50">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                <div className="bg-white border border-slate-200 p-4 rounded-xl flex flex-col shadow-sm">
                  ...
                  <p className="text-xl font-black text-slate-900">{new Intl.NumberFormat().format(supply.quantity)} <span className="text-sm font-bold text-slate-500 ml-1">{supply.quantityUnit || "MT"}</span></p>
                </div>
                <div className="bg-white border border-slate-200 p-4 rounded-xl flex flex-col shadow-sm">
