  ...
  return (
    <div className="flex flex-col flex-1 p-4 md:p-6 lg:p-10 font-sans min-h-full">
      ...
      <div className="max-w-[1400px] w-full mx-auto grid grid-cols-1 xl:grid-cols-2 gap-4 md:gap-8 items-start flex-1">
        ...
        {/* ========================================================= */}
        <div className="bg-white rounded-2xl md:rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex flex-col h-full lg:max-h-[calc(100vh-200px)]">
          ...
          <div className="bg-slate-900 px-4 md:px-6 py-4 md:py-5 flex items-center justify-between border-b border-slate-800 shrink-0">
            <div className="flex items-center gap-2 md:gap-3">
              <div className="bg-blue-500/20 p-1.5 md:p-2 rounded-lg border border-blue-500/30 text-blue-400">
            ...
            <div className="bg-blue-600 text-white text-[10px] md:text-xs font-bold px-2.5 md:px-3 py-1 rounded-full shadow-sm">
          ...
          <div className="p-4 md:p-6 space-y-4 md:space-y-5 bg-slate-50/50 flex-1 overflow-y-auto custom-scrollbar">
            {demands.length === 0 ? (
              ...
              demands.map((demand) => {
                ...
                return (
                  <div key={demand.id} className="bg-white border border-slate-200 rounded-xl md:rounded-2xl p-4 md:p-5 shadow-sm hover:shadow-md hover:border-blue-300 transition-all group">
                    ...
                    <div className="grid grid-cols-3 gap-2 md:gap-3 mb-4 md:mb-5">
                      <div className="bg-slate-50 rounded-lg md:rounded-xl p-2 md:p-3 border border-slate-100 flex flex-col justify-between">
                        <p className="text-[9px] md:text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 flex items-center gap-1 md:gap-1.5"><Scale size={10} className="md:w-3 md:h-3 text-blue-600 shrink-0"/> Qty</p>
                      ...
                      <div className="bg-slate-50 rounded-lg md:rounded-xl p-2 md:p-3 border border-slate-100 flex flex-col justify-between">
                        <p className="text-[9px] md:text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 flex items-center gap-1 md:gap-1.5"><CircleDollarSign size={10} className="md:w-3 md:h-3 text-blue-600 shrink-0"/> Target</p>
                        {demand.targetPrice ? (
                          <p className="text-xs md:text-sm font-black text-emerald-600 leading-none truncate">{new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD', maximumFractionDigits: 0 }).format(demand.targetPrice)}</p>
                        ) : (
                          <p className="text-[10px] md:text-xs font-bold text-slate-400 italic leading-none">TBD</p>
                        )}
                      </div>
                      <div className="bg-slate-50 rounded-lg md:rounded-xl p-2 md:p-3 border border-slate-100 flex flex-col justify-between">
                        <p className="text-[9px] md:text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 flex items-center gap-1 md:gap-1.5"><Calendar size={10} className="md:w-3 md:h-3 text-blue-600 shrink-0"/> Timeline</p>
                    ...
                    <form action={startChat}>
                      <button type="submit" className="w-full flex items-center justify-center gap-2 bg-blue-50 hover:bg-blue-600 text-blue-700 hover:text-white py-2 md:py-2.5 rounded-lg md:rounded-xl text-xs md:text-sm font-bold transition-colors border border-blue-100 hover:border-blue-600 shadow-sm">
        ...
        <div className="bg-white rounded-2xl md:rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex flex-col h-full lg:max-h-[calc(100vh-200px)]">
          ...
          <div className="bg-slate-900 px-4 md:px-6 py-4 md:py-5 flex items-center justify-between border-b border-slate-800 shrink-0">
            <div className="flex items-center gap-2 md:gap-3">
              <div className="bg-emerald-500/20 p-1.5 md:p-2 rounded-lg border border-emerald-500/30 text-emerald-400">
            ...
            <div className="bg-emerald-600 text-white text-[10px] md:text-xs font-bold px-2.5 md:px-3 py-1 rounded-full shadow-sm">
          ...
          <div className="p-4 md:p-6 space-y-4 md:space-y-5 bg-slate-50/50 flex-1 overflow-y-auto custom-scrollbar">
            {supplies.length === 0 ? (
              ...
              supplies.map((supply) => {
                ...
                return (
                  <div key={supply.id} className="bg-white border border-slate-200 rounded-xl md:rounded-2xl p-4 md:p-5 shadow-sm hover:shadow-md hover:border-emerald-300 transition-all group">
                    <div className="flex flex-col mb-3 md:mb-4">
                      <div className="flex justify-between items-start gap-3 md:gap-4">
                    ...
                    <div className="grid grid-cols-3 gap-2 md:gap-3 mb-4 md:mb-5">
                      <div className="bg-slate-50 rounded-lg md:rounded-xl p-2 md:p-3 border border-slate-100 flex flex-col justify-between">
                        <p className="text-[9px] md:text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 flex items-center gap-1 md:gap-1.5"><Scale size={10} className="md:w-3 md:h-3 text-emerald-600 shrink-0"/> Avail Qty</p>
                        <p className="text-xs md:text-sm font-black text-slate-900 leading-none truncate">
                      ...
                      <div className="bg-slate-50 rounded-lg md:rounded-xl p-2 md:p-3 border border-slate-100 flex flex-col justify-between">
                        <p className="text-[9px] md:text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 flex items-center gap-1 md:gap-1.5"><CircleDollarSign size={10} className="md:w-3 md:h-3 text-emerald-600 shrink-0"/> Price</p>
                        {supply.price ? (
                          <p className="text-xs md:text-sm font-black text-emerald-600 leading-none truncate">{new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD', maximumFractionDigits: 0 }).format(supply.price)}</p>
                        ) : (
                          <p className="text-[10px] md:text-xs font-bold text-slate-400 italic leading-none">TBD</p>
                        )}
                      </div>
                      <div className="bg-slate-50 rounded-lg md:rounded-xl p-2 md:p-3 border border-slate-100 flex flex-col justify-between">
                        <p className="text-[9px] md:text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1 flex items-center gap-1 md:gap-1.5"><MapPin size={10} className="md:w-3 md:h-3 text-emerald-600 shrink-0"/> Location</p>
                        <p className="text-[10px] md:text-xs font-bold text-slate-900 truncate leading-none" title={supply.location}>{supply.location}</p>
                      </div>
                    </div>

                    <form action={startChat}>
                      <button type="submit" className="w-full flex items-center justify-center gap-2 bg-emerald-50 hover:bg-emerald-600 text-emerald-700 hover:text-white py-2 md:py-2.5 rounded-lg md:rounded-xl text-xs md:text-sm font-bold transition-colors border border-emerald-100 hover:border-emerald-600 shadow-sm">
                        <MessageSquare size={16} className="shrink-0" /> <span className="truncate">Open Negotiation Room</span>
                      </button>
                    </form>
                  </div>
